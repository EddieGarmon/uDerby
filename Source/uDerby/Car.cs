...
namespace uDerby
{
    public class Car
    {
        ...
        public Car() {
            ...
            _modeSwitch = new DigitalInput(SecretLabs.NETMF.Hardware.NetduinoPlus.Pins.GPIO_PIN_D1, "mode switch", ResistorMode.PullUp, InterruptMode.InterruptEdgeBoth, 50);
            ...
            _triggerLock = new DigitalInput(SecretLabs.NETMF.Hardware.NetduinoPlus.Pins.GPIO_PIN_D2, "trigger-lock/e-stop", ResistorMode.PullUp, InterruptMode.InterruptEdgeBoth, 100);
            ...
            _lightsManager = Task.New(() => {
                                                var leftFrontLed = new DigitalLed(new DigitalOutput(SecretLabs.NETMF.Hardware.NetduinoPlus.Pins.GPIO_PIN_D13, false, "Left Front"));
                                                var rightFrontLed = new DigitalLed(new DigitalOutput(SecretLabs.NETMF.Hardware.NetduinoPlus.Pins.GPIO_PIN_D12, false, "Right Front"));
                                                var leftRearLed = new DigitalLed(new DigitalOutput(SecretLabs.NETMF.Hardware.NetduinoPlus.Pins.GPIO_PIN_D11, false, "Left Rear"));
                                                var rightRearLed = new DigitalLed(new DigitalOutput(SecretLabs.NETMF.Hardware.NetduinoPlus.Pins.GPIO_PIN_D10, false, "Right Rear"));
